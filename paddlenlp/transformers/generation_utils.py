...
class GenerationMixin(object):
    ...
    @staticmethod
    def get_logits_processor(min_length=None, eos_token_id=None,repetition_penalty=None):
    ...
    def generate(self,
        ...
        logits_processors = self.get_logits_processor(min_length, eos_token_id,repetition_penalty)
