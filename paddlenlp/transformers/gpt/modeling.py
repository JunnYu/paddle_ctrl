...
class GPTEmbeddings(nn.Layer):
    ...
    def __init__(self,
        ...
        self.word_embeddings = nn.Embedding(
            vocab_size,
            hidden_size,
            weight_attr=paddle.ParamAttr(name="word_embeddings",initializer=nn.initializer.Normal(
                mean=0.0, std=initializer_range)))

        self.position_embeddings = nn.Embedding(
            max_position_embeddings,
            hidden_size,
            weight_attr=paddle.ParamAttr(name="position_embeddings",initializer=nn.initializer.Normal(
                mean=0.0, std=initializer_range)))
